...
#include "../../../CommandCenter/Link/linkinterface.h"
...
QT_MOC_LITERAL(1, 14, 12), // "readFinished"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 4), // "data"
QT_MOC_LITERAL(4, 33, 16), // "invokeWriteBytes"
QT_MOC_LITERAL(5, 50, 12), // "linkFinished"
QT_MOC_LITERAL(6, 63, 16) // "linkTimeOutReply"

    },
    "LinkInterface\0readFinished\0\0data\0"
    "invokeWriteBytes\0linkFinished\0"
    "linkTimeOutReply"
};
...
void LinkInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readFinished((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->invokeWriteBytes((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->linkFinished(); break;
        case 3: _t->linkTimeOutReply(); break;
        default: ;
        }
        ...
        {
            typedef void (LinkInterface::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkInterface::readFinished)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkInterface::invokeWriteBytes)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LinkInterface::readFinished(const QByteArray & _t1)
{
...
// SIGNAL 1
void LinkInterface::invokeWriteBytes(QByteArray _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
